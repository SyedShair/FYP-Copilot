# Description: this file contain manual test cases for fault_injection_palindrome function
import unittest
...
class TestPalindrome(unittest.TestCase):
    ...
    def test_palindrome(self):  # test the word is palindrome
        ...
        sut = fault_injection_palindrome.palindrome(Input)  # software under test

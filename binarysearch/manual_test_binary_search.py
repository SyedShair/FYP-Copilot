# Description: This file contains the test cases for the binary_search method
...
class TestBinarySearch(unittest.TestCase):
    ...
    def test_binary_search_emptyArray(self):  # binary search method when string is empty
        ...
        sut = binary_search.binary_search(array, target)  # here is the software under test
        Output = sut  # the binary_search method is called
        self.assertEqual(Output, -1)
